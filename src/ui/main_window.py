...
from core.utils import (
    ...
    get_user_downloads_dir, get_subprocess_creationflags
)
...
class MainWindow(QMainWindow):
    ...
    def ctx_move(self, item):
        ...
        if new_path is None:
            ...
            # None on Windows (and on any Linux desktop without a portal running) --
            # fall back to Qt's own cross-platform native dialog.
